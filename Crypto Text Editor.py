...
main_application.title('Crypto Text Editor')
...
#file icons
#here adding icons
new_icon = tk.PhotoImage(file='icons2/new.png') #PhotoImage is used for adding icons
...
#below first is the text color and second is the background color 000000 is for text and ffffff is bckground
color_dict = {
...
tool_bar.pack(side=tk.TOP, fill=tk.X)#for vertical fill tk.TOP,for horizontal fill tk.X
...
#below code is used to hide and show toolbar and statusbar
